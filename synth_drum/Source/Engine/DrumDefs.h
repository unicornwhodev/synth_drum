...
// =========================================================================
// Internal V2 algorithm identity. This does not replace PadVoiceModel:
// PadVoiceModel remains the 9-family voice factory contract, while this maps
// every public pad to a distinct dedicated algorithm.
// =========================================================================
enum class DrumInstrumentAlgorithm : uint8_t
{
    KickA,
    KickB,
    Snare,
...
enum class DrumEngineReadiness : uint8_t
{
    LegacyFamily,
    DedicatedVoice
};

enum class DrumRenderEngineMode : uint8_t
{
    LegacyFamily,
    V2ModelOnly,
    V2
...
constexpr int kNumDrumInstrumentAlgorithms = kNumPads;

constexpr std::array<DrumInstrumentAlgorithm, kNumPads> kPadAlgorithms = {{
    DrumInstrumentAlgorithm::KickA,
    DrumInstrumentAlgorithm::KickB,
    DrumInstrumentAlgorithm::Snare,
    DrumInstrumentAlgorithm::Clap,
    DrumInstrumentAlgorithm::HatClosed,
    DrumInstrumentAlgorithm::HatOpen,
    DrumInstrumentAlgorithm::Perc1Wood,
    DrumInstrumentAlgorithm::Perc2Metal,
    DrumInstrumentAlgorithm::TomLow,
    DrumInstrumentAlgorithm::TomHigh,
    DrumInstrumentAlgorithm::Crash,
    DrumInstrumentAlgorithm::Fx
}};
...
inline DrumInstrumentAlgorithm getPadAlgorithm(int padIndex)
{
    const auto clamped = padIndex < 0 ? 0 : (padIndex >= kNumPads ? kNumPads - 1 : padIndex);
    return kPadAlgorithms[static_cast<std::size_t>(clamped)];
}

inline DrumEngineReadiness getPadReadiness(int)
{
    return DrumEngineReadiness::DedicatedVoice;
}

inline const char* getAlgorithmName(const DrumInstrumentAlgorithm algorithm)
{
    switch (algorithm)
    {
        case DrumInstrumentAlgorithm::KickA:      return "KickA";
        case DrumInstrumentAlgorithm::KickB:      return "KickB";
        case DrumInstrumentAlgorithm::Snare:      return "Snare";
        case DrumInstrumentAlgorithm::Clap:       return "Clap";
        case DrumInstrumentAlgorithm::HatClosed:  return "HatClosed";
        case DrumInstrumentAlgorithm::HatOpen:    return "HatOpen";
        case DrumInstrumentAlgorithm::Perc1Wood:  return "Perc1Wood";
        case DrumInstrumentAlgorithm::Perc2Metal: return "Perc2Metal";
        case DrumInstrumentAlgorithm::TomLow:     return "TomLow";
        case DrumInstrumentAlgorithm::TomHigh:    return "TomHigh";
        case DrumInstrumentAlgorithm::Crash:      return "Crash";
        case DrumInstrumentAlgorithm::Fx:         return "Fx";
    }

    return "Unknown";
}

inline const char* getPadAlgorithmName(const int padIndex)
{
    return getAlgorithmName(getPadAlgorithm(padIndex));
}
