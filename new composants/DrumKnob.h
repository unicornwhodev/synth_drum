    ...
    : lnf(ac), accentColour(ac)
{
    ...
    label.setFont(UITheme::fontSmall().withHeight(9.2f));
    label.setColour(juce::Label::textColourId, UITheme::textDim().withAlpha(0.78f));
...
inline void DrumKnob::resized()
{
    ...
    label.setBounds(area.removeFromBottom(15));
